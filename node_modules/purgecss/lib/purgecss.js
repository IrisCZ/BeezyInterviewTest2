...
. and .. elements in a path array with directory names there
, empty elements, or device names (c:\) in the array
...
[root, dir, basename, ext], unix version
, or nothing.
...
() {
  ...
  , but
  (might happen when process.cwd() fails)
...
(path) {
  ...
  = normalizeArray(filter(path.split('/'), function (p) {
    return !!p;
  }), !isPathAbsolute).join('/');
...
.prototype.substr - negative index don't work in IE8
...
= function () {
    ...
    createClass(Purgecss, [{
        ...
        value: function purge() {
            ...
            .getCssContents(css, new Set([].concat(toConsumableArray(cssFileSelectors), toConsumableArray(cssRawSelectors))));
        }
        ...
        value: function getCssContents(cssOptions, cssSelectors) {
            ...
            = cssOptions.map(function (option) {
                    ...
                    if (selector.type === 'selector') {
                        ...
                        try {
                            for (var _iterator7 = selector.nodes[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
                                ...
                                } else if (type === 'tag' && !/[+]|(even)|(odd)|^from$|^to$|^\d/.test(value)) {
                                    (e.g. 2n in :nth-child(2n))
                                    selectorsInRule.push(value);
                                }
                            }
                        } catch (err) {
        ...
        value: function shouldKeepSelector(selectorsInContent, selectorsInRule) {
            ...
            try {
                for (var _iterator11 = selectorsInRule[Symbol.iterator](), _step11; !(_iteratorNormalCompletion11 = (_step11 = _iterator11.next()).done); _iteratorNormalCompletion11 = true) {
                    ...
                    , simply
                    (this.isSelectorWhitelistedChildren(unescapedSelector)) {
                        return true;
                    }

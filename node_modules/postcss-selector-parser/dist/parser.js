...
var Parser = function () {
        ...
        while (pos < len) {
            ...
            switch (token[_tokenize.FIELDS.TYPE]) {
                case tokens.space:
                    ...
                    .expected('attribute', token[TOKEN.START_POS], content);
                    }
                ...
                case tokens.combinator:
                    ...
                    break;
                case tokens.word:
                    if (next && this.content(next) === '|' && attr[pos + 2] && attr[pos + 2][_tokenize.FIELDS.TYPE] !== tokens.equals && -ahead probably fails with comment nodes involved.
    ...
    Parser.prototype.combinator = function combinator() {
        ...
        if (node) {
            ...
            = this.convertWhitespaceNodesToSpace(spaceOrDescendantSelectorNodes, true),
    ...
    Parser.prototype.parentheses = function parentheses() {
        ...
        if (last && last.type === types.PSEUDO) {
            ...
            . It's used to implement a basic parse of media queries
            .
    ...
    Parser.prototype.space = function space() {
        ...
        (this.position === 0 || this.prevToken[_tokenize.FIELDS.TYPE] === tokens.comma || this.prevToken[_tokenize.FIELDS.TYPE] === tokens.openParenthesis) {

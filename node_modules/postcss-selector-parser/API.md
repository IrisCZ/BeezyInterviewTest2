...
Example: `[  href /* after-attr */ = /* after-operator */ te/*inside-value*/st i ]` would parse as:
...
```js
{
  ...
  raws: {
    spaces: {
      attribute: { before: '  ', after: ' /* after-attr */ ' },
...
([documentation](http:.postcss.org/Container.html#error)).
...
: classValidator: ./test.css:1:5: classes may not have underscores or dashes in them
> 1 | .foo-bar {
|     ^
|   color: red;
| }

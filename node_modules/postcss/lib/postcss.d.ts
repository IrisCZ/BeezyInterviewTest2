...
declare namespace postcss {
    ...
    interface ContainerBase extends NodeBase {
         ...
         *     root.prepend({ name: '@charset', params: '"UTF-8"' }); -rule
         *     root.prepend({ selector: 'a' });                       *     rule.prepend({ prop: 'color', value: 'black' });       *     rule.prepend({ text: 'Comment' })                      * A string containing the CSS of the new element can also be used. This
         ...
         * Because each node class is identifiable by unique properties, use the
         * following shortcuts to create nodes in insert methods:
         *     root.append({ name: '@charset', params: '"UTF-8"' }); -rule
         *     root.append({ selector: 'a' });                       *     rule.append({ prop: 'color', value: 'black' });       *     rule.append({ text: 'Comment' })                      * A string containing the CSS of the new element can also be used. This
         * approach is slower than the above shortcuts.
         *     root.append('a {}');

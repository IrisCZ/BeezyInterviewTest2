...
`@babel/template` accepts all of the options from [babylon](https:.com/babel/babel/tree/master/packages/babylon), and specifies
...
[babylon]: https:.com/babel/babylon#options
